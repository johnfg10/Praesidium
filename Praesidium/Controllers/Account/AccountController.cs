...
using Praesidium.ViewModels.Account;

namespace Praesidium.Controllers.Account
{
    [SecurityHeaders]
    [AllowAnonymous]
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Admin()
        {
            ...
            await _userManager.AddClaimAsync(user, new Claim("235848.Staff.Owner", ""));
